...
public class ControllerDialogReg<O extends DialogReg, M extends ModelDialogReg>
        extends ControllerDialogDefault<O, M> {

    public ControllerDialogReg(O object, M model) {
        super(object, model);
    }
