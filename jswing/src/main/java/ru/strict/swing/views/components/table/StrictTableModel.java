 ...
 * StrictTableModel tablemodel = new StrictTableModel(masO, str); <br/>
 ...
 * setVisible(true); <br/>
 */
public class StrictTableModel extends AbstractTableModel {
     ...
     */
    public StrictTableModel(Object[][] masContentTable, String[] masTitleTable) {
        super();
     ...
     */
    public StrictTableModel(List<List<Object>> listContentTable, Collection<String> listTitleTable) {
        super();
     ...
     * @param masTitleTable   массив заголовков таблицы
     */
    public StrictTableModel(String[][] masContentTable, String[] masTitleTable) {
        super();
    ...
    public static void setNewContent(JTable table, Collection<String> listTitle, List<List<Object>> list) {
        StrictTableModel tableModel = (StrictTableModel) table.getModel();
