 ...
 */
public class DialogReg<M extends ModelDialogReg> extends DialogDefault<M> {

    @Override
    public DialogReg build(M model) {
        super.build(model);
        UtilLogger.info(DialogReg.class, "build - started");
        ...
        UtilLogger.info(DialogReg.class, "build - finished");
        return this;
    }
