...
CREATE TABLE userx(id TEXT NOT NULL, username TEXT NOT NULL, passwordencode TEXT NOT NULL, token TEXT NOT NULL, CONSTRAINT pk_userx PRIMARY KEY (id), CONSTRAINT uq_userx_username UNIQUE (username), CONSTRAINT uq_userx_token UNIQUE (token));
