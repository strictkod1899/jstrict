...
import ru.strict.db.migration.components.MigrationForeignBehavior;
import ru.strict.db.migration.components.MigrationForeignKey;
...
public class PostgreSQLMigrationForeignKey extends MigrationForeignKey {
    ...
    @Override
    public int hashCode(){
        return Objects.hash(getName(), getColumn(), getTableRef(), getColumnRef(),
                getUpdateBehavior(), getDeleteBehavior(), schema);
    }
    //</editor-fold>
}
