...
import ru.strict.db.core.dao.BaseDao;
...
import ru.strict.db.core.query.components.Where;
...
import static ru.strict.db.jdbc.util.JdbcUtil.*;
...
public abstract class JdbcDao
        ...
        extends BaseDao<ID, Connection, IConnectionCreator<Connection>, MODEL> {
    ...
    @Override
    protected final List<MODEL> processReadAll(IParameterizedQuery requests) {
    ...
    @Override
    public final long readCount(IParameterizedQuery request) {
