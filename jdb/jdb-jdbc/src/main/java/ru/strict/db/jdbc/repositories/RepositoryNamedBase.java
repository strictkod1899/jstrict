...
public abstract class RepositoryNamedBase
    ...
    /**
     * Чтение записи из базы данных по наименованию (столбец 'caption')
     * @param caption Значение столбца наименования (caption)
     * @return
     */
    public DTO readByName(String caption){
        DbRequests requests = new DbRequests(getTableName(), true);
        requests.add(new DbWhere(getTableName(), "caption", caption, "="));
