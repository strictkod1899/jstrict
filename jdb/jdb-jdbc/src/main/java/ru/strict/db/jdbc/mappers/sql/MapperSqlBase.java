 ...
 */
public abstract class MapperSqlBase<ID, T extends IModel<ID>>
    ...
    public MapperSqlBase(){
        this.columns = null;
        this.idType = null;
        this.idColumnName = null;
    }

    public MapperSqlBase(String[] columns){
        this.columns = columns;
        this.idType = null;
        this.idColumnName = null;
    }

    public MapperSqlBase(String[] columns, SQLType idType, String idColumnName){
        this.columns = columns;
        this.idType = idType;
