...
public class TestRepositoryJWTToken extends TestBase {
    ...
    private static void prepareData(){
        ...
        repositoriesForClearDb.add(repositoryCountryNumberId);
        repositoriesForClearDb.add(repositoryCountryUuidId);
