...
public class TestRepositoryRole {
    ...
    private static IRepositoryNamed<Integer, Role<Integer>> REPOSITORY_NOT_GENERATE_ID;
    private static IRepositoryNamed<Integer, Role<Integer>> REPOSITORY_GENERATE_NUMBER_ID;
    ...
    private static void prepareRepositories(){
        REPOSITORY_NOT_GENERATE_ID = new RepositoryRole<>(CREATE_DB_INTEGER_CONNECTION, GenerateIdType.NONE);
        REPOSITORY_GENERATE_NUMBER_ID = new RepositoryRole<>(CREATE_DB_INTEGER_CONNECTION, GenerateIdType.INT);
        REPOSITORY_GENERATE_UUID_ID = new RepositoryRole<>(CREATE_DB_UUID_CONNECTION, GenerateIdType.UUID);
    ...
    public void test005ReadByUuid(){
        Role model = REPOSITORY_GENERATE_UUID_ID.read((UUID)data[1].getId());
    ...
    public void test007ReadAllUuid(){
        List<Role<UUID>> list = REPOSITORY_GENERATE_UUID_ID.readAll(null);
    ...
    private void convertUUIDModel(Role model){
