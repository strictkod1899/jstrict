...
import ru.strict.db.mybatis.repositories.RepositoryProfileDetails;
...
public class TestRepositoryProfileDetails {
    ...
    private static void prepareRepositories(){
        REPOSITORY_NOT_GENERATE_ID = new RepositoryProfileDetails<>(CREATE_DB_INTEGER_CONNECTION, GenerateIdType.NONE);
        REPOSITORY_GENERATE_NUMBER_ID = new RepositoryProfileDetails<>(CREATE_DB_INTEGER_CONNECTION, GenerateIdType.INT);
        REPOSITORY_GENERATE_UUID_ID = new RepositoryProfileDetails<>(CREATE_DB_UUID_CONNECTION, GenerateIdType.UUID);
