...
public class MapperSqlJWTUserToken implements RowMapper<EntityJWTUserToken> {
    ...
    @Override
    public EntityJWTUserToken mapRow(ResultSet resultSet, int i) throws SQLException {
