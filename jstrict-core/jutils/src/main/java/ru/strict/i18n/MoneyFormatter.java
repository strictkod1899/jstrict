    ...
    static {
        DEFAULT_UNITS.put(
                ...
                CurrencyUnits.builder()
                        ...
                        .integerUnits(new String[]{"рублей", "рубль", "рубля", "рубля", "рубля", "рублей", "рублей", "рублей", "рублей", "рублей"})
                        .fractionalUnits(new String[]{"копеек", "копейка", "копейки", "копейки", "копейки", "копеек", "копеек", "копеек", "копеек", "копеек"})
                        .build()
        );
        DEFAULT_UNITS.put(
                Currency.KZT,
                CurrencyUnits.builder()
                        ...
                        .integerUnits(new String[]{"тенге", "тенге", "тенге", "тенге", "тенге", "тенге", "тенге", "тенге", "тенге", "тенге"})
                        .fractionalUnits(new String[]{"тиын", "тиын", "тиын", "тиын", "тиын", "тиын", "тиын", "тиын", "тиын", "тиын"})
                        .build()
        );
        DEFAULT_UNITS.put(
                Currency.USD,
                CurrencyUnits.builder()
                        ...
                        .integerUnits(new String[]{"долларов", "доллар", "доллара", "доллара", "доллара", "долларов", "долларов", "долларов", "долларов", "долларов"})
                        .fractionalUnits(new String[]{"центов", "цент", "цента", "цента", "цента", "центов", "центов", "центов", "центов", "центов"})
                        .build()
        );
        DEFAULT_UNITS.put(
                Currency.EUR,
                CurrencyUnits.builder()
                        ...
                        .integerUnits(new String[]{"евро", "евро", "евро", "евро", "евро", "евро", "евро", "евро", "евро", "евро"})
                        .fractionalUnits(new String[]{"центов", "цент", "цента", "цента", "цента", "центов", "центов", "центов", "центов", "центов"})
                        .build()
        );
        DEFAULT_UNITS.put(
                ...
                CurrencyUnits.builder()
                        ...
                        .integerUnits(new String[]{"фунтов стерлингов", "фунт стерлингов", "фунта стерлингов", "фунта стерлингов", "фунта стерлингов", "фунтов стерлингов",
                                "фунтов стерлингов", "фунтов стерлингов", "фунтов стерлингов", "фунтов стерлингов"})
                        .fractionalUnits(new String[]{"пенсов", "пенс", "пенса", "пенса", "пенса", "пенсов", "пенсов", "пенсов", "пенсов", "пенсов"})
                        .build()
        );
        DEFAULT_UNITS.put(
                Currency.CNY,
                CurrencyUnits.builder()
                        ...
                        .integerUnits(new String[]{"юаней", "юань", "юаня", "юаня", "юаня", "юаней", "юаней", "юаней", "юаней", "юаней"})
        ...
        DEFAULT_UNITS.put(
                ...
                CurrencyUnits.builder()
                        ...
                        .integerUnits(new String[]{"белорусских рублей", "белорусский рубль", "белорусских рубля", "белорусских рубля", "белорусских рубля",
                                "белорусских рублей", "белорусских рублей", "белорусских рублей", "белорусских рублей", "белорусских рублей"})
                        .fractionalUnits(new String[]{"копеек", "копейка", "копейки", "копейки", "копейки", "копеек", "копеек", "копеек", "копеек", "копеек"})
                        .build()
        );
        DEFAULT_UNITS.put(
                ...
                CurrencyUnits.builder()
                        ...
                        .integerUnits(new String[]{"гривен", "гривна", "гривны", "гривны", "гривны", "гривен", "гривен", "гривен", "гривен", "гривен"})
                        .fractionalUnits(new String[]{"", "", "", "", "", "", "", "", "", ""})
                        .build()
        );
        DEFAULT_UNITS.put(
                ...
                CurrencyUnits.builder()
                        ...
                        .integerUnits(new String[]{"киргизских сомов", "киргизский сом", "киргизских сома", "киргизских сома", "киргизских сома",
                                "киргизских сомов", "киргизских сомов", "киргизских сомов", "киргизских сомов", "киргизских сомов"})
                        .fractionalUnits(new String[]{"", "", "", "", "", "", "", "", "", ""})
                        .build()
        );
        DEFAULT_UNITS.put(
                ...
                CurrencyUnits.builder()
                        ...
                        .integerUnits(new String[]{"армянских драмов", "армянский драм", "армянских драма", "армянских драма", "армянских драма",
                                "армянских драмов", "армянских драмов", "армянских драмов", "армянских драмов", "армянских драмов"})
                        .fractionalUnits(new String[]{"", "", "", "", "", "", "", "", "", ""})
                        .build()
        );
        DEFAULT_UNITS.put(
                ...
                CurrencyUnits.builder()
                        ...
                        .integerUnits(new String[]{"турецкая лира", "турецкая лира", "турецкая лира", "турецкая лира", "турецкая лира",
                                "турецкая лира", "турецкая лира", "турецкая лира", "турецкая лира", "турецкая лира"})
                        .fractionalUnits(new String[]{"", "", "", "", "", "", "", "", "", ""})
                        .build()
        );
        DEFAULT_UNITS.put(
                ...
                CurrencyUnits.builder()
                        ...
                        .integerUnits(new String[]{"тайский бат", "тайский бат", "тайский бат", "тайский бат", "тайский бат", "тайский бат",
                                "тайский бат", "тайский бат", "тайский бат", "тайский бат"})
                        .fractionalUnits(new String[]{"", "", "", "", "", "", "", "", "", ""})
                        .build()
        );
        DEFAULT_UNITS.put(
                ...
                CurrencyUnits.builder()
                        ...
                        .integerUnits(new String[]{"южнокорейская вона", "южнокорейская вона", "южнокорейская вона", "южнокорейская вона", "южнокорейская вона",
                                "южнокорейская вона", "южнокорейская вона", "южнокорейская вона", "южнокорейская вона", "южнокорейская вона"})
                        .fractionalUnits(new String[]{"", "", "", "", "", "", "", "", "", ""})
                        .build()
        );
        DEFAULT_UNITS.put(
                ...
                CurrencyUnits.builder()
                        ...
                        .integerUnits(new String[]{"дирхам ОАЭ", "дирхам ОАЭ", "дирхам ОАЭ", "дирхам ОАЭ", "дирхам ОАЭ", "дирхам ОАЭ",
                                "дирхам ОАЭ", "дирхам ОАЭ", "дирхам ОАЭ", "дирхам ОАЭ"})
                        .fractionalUnits(new String[]{"", "", "", "", "", "", "", "", "", ""})
                        .build()
        );
        DEFAULT_UNITS.put(
                ...
                CurrencyUnits.builder()
                        ...
                        .integerUnits(new String[]{"узбекский сум", "узбекский сум", "узбекский сум", "узбекский сум", "узбекский сум", "узбекский сум",
                                "узбекский сум", "узбекский сум", "узбекский сум", "узбекский сум"})
                        .fractionalUnits(new String[]{"", "", "", "", "", "", "", "", "", ""})
                        .build()
        );
        DEFAULT_UNITS.put(
                ...
                CurrencyUnits.builder()
                        ...
                        .integerUnits(new String[]{"монгольский тугрик", "монгольский тугрик", "монгольский тугрик", "монгольский тугрик", "монгольский тугрик",
                                "монгольский тугрик", "монгольский тугрик", "монгольский тугрик", "монгольский тугрик", "монгольский тугрик"})
                        .fractionalUnits(new String[]{"", "", "", "", "", "", "", "", "", ""})
                        .build()
        );
        DEFAULT_UNITS.put(
                ...
                CurrencyUnits.builder()
                        ...
                        .integerUnits(new String[]{"польский злотый", "польский злотый", "польский злотый", "польский злотый", "польский злотый",
                                "польский злотый", "польский злотый", "польский злотый", "польский злотый", "польский злотый"})
                        .fractionalUnits(new String[]{"", "", "", "", "", "", "", "", "", ""})
                        .build()
        );
        DEFAULT_UNITS.put(
                ...
                CurrencyUnits.builder()
                        ...
                        .integerUnits(new String[]{"азербайджанский манат", "азербайджанский манат", "азербайджанский манат", "азербайджанский манат", "азербайджанский манат",
                                "азербайджанский манат", "азербайджанский манат", "азербайджанский манат", "азербайджанский манат", "азербайджанский манат"})
                        .fractionalUnits(new String[]{"", "", "", "", "", "", "", "", "", ""})
                        .build()
        );
    }
            ...
            case FRACTIONAL: {
                if (sumText.length() > 1) {
                    if (sumText.charAt(0) != '1') {
                        unit = getFractionalUnit(currency, Character.getNumericValue(sumText.charAt(sumText.length() - 1)));
                    } else {
