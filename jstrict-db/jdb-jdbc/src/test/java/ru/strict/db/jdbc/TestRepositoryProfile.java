...
public class TestRepositoryProfile extends TestBase {

    private static Profile[] data;

    private static IRepositoryProfile<Long, Profile<Long>> REPOSITORY_NOT_GENERATE_ID;
    private static IRepositoryProfile<Long, Profile<Long>> REPOSITORY_GENERATE_NUMBER_ID;
    ...
    private static void prepareRepositories(){
        REPOSITORY_NOT_GENERATE_ID = new RepositoryProfile<>(CREATE_DB_INTEGER_CONNECTION, GenerateIdType.NONE, JDBCType.BIGINT);
        REPOSITORY_GENERATE_NUMBER_ID = new RepositoryProfile<>(CREATE_DB_INTEGER_CONNECTION, GenerateIdType.LONG, JDBCType.BIGINT);
        REPOSITORY_GENERATE_UUID_ID = new RepositoryProfile<>(CREATE_DB_UUID_CONNECTION, GenerateIdType.UUID, SqlType.UUID);
    ...
    private static void prepareData(){
        ...
        repositoriesForClearDb.add(repositoryCityNumberId);
        repositoriesForClearDb.add(repositoryCityUuidId);
    ...
    public void test019ReadBySurname(){
        // TODO: тест, чтобы surname был null
