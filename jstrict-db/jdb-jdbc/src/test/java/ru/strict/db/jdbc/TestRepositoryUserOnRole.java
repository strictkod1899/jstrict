...
public class TestRepositoryUserOnRole extends TestBase {

    private static UserOnRole[] data;

    private static IRepositoryUserOnRole<Long> REPOSITORY_NOT_GENERATE_ID;
    private static IRepositoryUserOnRole<Long> REPOSITORY_GENERATE_NUMBER_ID;
    ...
    private static void prepareRepositories(){
        REPOSITORY_NOT_GENERATE_ID = new RepositoryUserOnRole<>(CREATE_DB_INTEGER_CONNECTION, GenerateIdType.NONE, JDBCType.BIGINT);
        REPOSITORY_GENERATE_NUMBER_ID = new RepositoryUserOnRole<>(CREATE_DB_INTEGER_CONNECTION, GenerateIdType.LONG, JDBCType.BIGINT);
        REPOSITORY_GENERATE_UUID_ID = new RepositoryUserOnRole<>(CREATE_DB_UUID_CONNECTION, GenerateIdType.UUID, SqlType.UUID);
    ...
    private static void prepareData(){
        ...
        repositoriesForClearDb.add(repositoryUserNumberId);
        repositoriesForClearDb.add(repositoryUserUuidId);
    ...
    public void test020ReadByRoleId(){
        List list = REPOSITORY_GENERATE_NUMBER_ID.readByRoleId((Long)data[2].getRoleId());
        Assert.assertEquals(2, list.size());
    }
}
