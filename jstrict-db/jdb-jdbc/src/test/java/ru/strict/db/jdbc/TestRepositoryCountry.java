...
public class TestRepositoryCountry extends TestBase {

    private static Country[] data;

    private static IRepositoryNamed<Long, Country<Long>> REPOSITORY_NOT_GENERATE_ID;
    private static IRepositoryNamed<Long, Country<Long>> REPOSITORY_GENERATE_NUMBER_ID;
    ...
    private static void prepareRepositories(){
        REPOSITORY_NOT_GENERATE_ID = new RepositoryCountry<>(CREATE_DB_INTEGER_CONNECTION, GenerateIdType.NONE, JDBCType.BIGINT);
        REPOSITORY_GENERATE_NUMBER_ID = new RepositoryCountry<>(CREATE_DB_INTEGER_CONNECTION, GenerateIdType.LONG, JDBCType.BIGINT);
        REPOSITORY_GENERATE_UUID_ID = new RepositoryCountry<>(CREATE_DB_UUID_CONNECTION, GenerateIdType.UUID, SqlType.UUID);
